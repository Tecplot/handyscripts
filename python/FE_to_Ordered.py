    ...
    if fezone.zone_type == tp.constant.ZoneType.FELineSeg:
        ...
        while continue_line: 
            ...
            try: 
                ...
                continue_line = False # Stops if no LHS of the coorisponds to the RSH, this happens if the line is not a loop. 
        ...
        for var in range(fezone.num_variables): # For all variables
            ...
            for FE_idx in index_list: 
                ordered_vals[ordered_idx] = FE_vals[FE_idx] # Overwrite the values of the ordered zone 
                ordered_idx +=1
